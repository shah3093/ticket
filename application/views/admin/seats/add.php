<div class="box box-info">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form class="form-horizontal" method="post" action="<?php echo base_url("admin/seats/addformdb"); ?>"  id="frmAdd"  enctype="multipart/form-data">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input class="form-control required" name="Seat[name]"  placeholder="Name" type="text">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <textarea name="Seat[details]" class="form-control summernote" id="details" placeholder="Details"></textarea>
                </div>
            </div>
