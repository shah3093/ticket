var current_url = base_url + "admin/sports/listing";
...
$(function () {
    ...
    $("body").on("click", "#addform", function (e) {
        ...
        $("#listing").html(" ");
        $("#loadergif").show();
        $.post(base_url + "admin/sports/formview", {}, function (result) {
            $("#listing").html(" ");
            $("#loadergif").hide();
            $("#addform").hide();
    ...
    $("body").on("click", ".edit", function (e) {
        ...
        $("#listing").html(" ");
        $("#loadergif").show();
        $.post(base_url + "admin/sports/formview/" + id, {}, function (result) {
            $("#listing").html(" ");
            $("#loadergif").hide();
            $("#addform").hide();
            $("#contentform").html(result);
    ...
    $("body").on("click", ".delete", function (e) {
        ...
        swal({
            ...
            closeOnConfirm: true
                ...
                function () {
                    $.post(base_url + "admin/sports/delete/" + id, {}, function () {
                        load_data(current_url);
                    });
                });
    });
